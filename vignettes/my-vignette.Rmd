...
knitr::opts_knit$set(root.dir ="/Users/humengtong/Dropbox (University of Michigan)/from_box/Summer2020/Rpackages/myfirstpackage")
```
...
```{r}
y_treated_sum=0;y_control_sum = 0 ; n_treated =0; n_control= 0 
output = Update_ate(betahat,A,y,X,y_treated_sum,y_control_sum,n_treated,n_control)
...
betahat = output$beta_ps
y_treated_sum =output$y_treated_sum; y_control_sum=output$y_control_sum; n_treated = output$n_treated;n_control = output$n_control
output = Update_ate(betahat,A,y,X,y_treated_sum,y_control_sum,n_treated,n_control,TRUE)
#Site 4 finishes analysis and save the results in the designated directory where every group will have access to.
b=solve(bread)
return(c("ATE"=ATE_ps123_av,"var"=(b%*%meat%*%t(b))[dim(b)[1],dim(b)[2]],"ATE_ps123_av_b1"=ATE_ps123_av_b1))
